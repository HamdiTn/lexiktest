...
use lexiktestBundle\Entity\Groups;
...
class GroupsController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $groups = $em->getRepository('lexiktestBundle:Groups')->findAll();
    ...
    {
        $group = new Groups();
        $form = $this->createForm('lexiktestBundle\Form\GroupsType', $group);
    ...
    {
        $editForm = $this->createForm('lexiktestBundle\Form\GroupsType', $group);
